...
""".trimIndent(),
        ...
        "request_in_progress" to "⏳ Please wait, your previous request is still loading...",
        "btn_trying" to "⏳ Trying... Please wait",
        "loading_details_tag" to "⏳ Trying to fetch details...",
        "loading_episodes_tag" to "⏳ Trying to load episodes...",
        "resolving_links_tag" to "⏳ Trying to extract streaming links...",
        "loading_feed_tag" to "⏳ Trying to load feed...",
        "searching_tag" to "⏳ Trying to search in source...",
        "loading_details_msg" to "⏳ *Fetching details...*\nPlease wait a moment.",
        "loading_episodes_msg" to "⏳ *Loading episodes list...*\nPlease wait a moment.",
        "resolving_links_msg" to "⏳ *Extracting and resolving streaming links...*\nPlease wait a moment.",
        "loading_feed_msg" to "⏳ *Loading titles...*\nPlease wait a moment.",
...
""".trimIndent(),
        ...
        "btn_open_website" to "🌐 Open Link",
        "btn_view_album" to "🖼 View Album",
        "btn_image_pager" to "🖼 Photo Pager & Gallery",
        "btn_list_view" to "📋 List View",
        "album_fallback_pager" to "⚠️ Telegram cannot load multi-photo albums from this host. Opening interactive photo pager!",
        "album_sent_success" to "✅ Photo album sent! Tap below to open full interactive pager:",
        "poster_viewing_item" to "Now viewing #%d: *%s*",
        "no_links_open_web" to "⚠️ *No direct streaming links found for this title.*\n\n👇 You can open and watch directly on the provider's website:",
        "load_failed_open_web" to "⚠️ *Could not load media details from '%s'.*\n\nDue to Cloudflare protection, timeout, or site restrictions, details could not be loaded in the bot.\n\n👇 You can open the page directly in your browser to view or watch:",
        "btn_open_browser" to "🌐 Open Link",
        "btn_back" to "⬅️ Back",
        ...
        "feed_latest_title" to "✨ *Latest & Recent Releases*\nSource: *%s*",
        "btn_switch_source" to "🔄 Switch Source",
        "btn_random" to "🎲 Surprise Me",
        "btn_history" to "🕒 Watch History",
        "btn_categories" to "📂 Categories",
        "btn_continue_watch" to "▶️ Resume: %s",
        "btn_web_player" to "🎬 Web Player",
        "history_title" to "🕒 *Watch History & Continue Watching*\n\n👇 Tap any title to resume watching:",
        "history_empty" to "🕒 You haven't watched any movies or series yet.\nSearch and start watching now!",
        "categories_title" to "📂 *Categories & Sections*\nSource: *%s*\n\n👇 Select a category to explore:",
        "categories_empty" to "⚠️ No specific categories available for this source.",
        "random_title" to "🎲 *Surprise Pick for Tonight!*",
        "random_empty" to "⚠️ Could not pick a random title right now. Try browsing Popular instead.",
...
""".trimIndent(),
        ...
        "request_in_progress" to "⏳ لطفاً کمی صبر کنید، درخواست قبلی شما در حال پردازش است...",
        "btn_trying" to "⏳ در حال تلاش... لطفاً صبر کنید",
        "loading_details_tag" to "⏳ در حال دریافت مشخصات...",
        "loading_episodes_tag" to "⏳ در حال بارگذاری قسمت‌ها...",
        "resolving_links_tag" to "⏳ در حال استخراج لینک‌های پخش...",
        "loading_feed_tag" to "⏳ در حال دریافت فهرست...",
        "searching_tag" to "⏳ در حال جستجو در سورس...",
        "loading_details_msg" to "⏳ *در حال دریافت مشخصات عنوان...*\nلطفاً چند لحظه شکیبا باشید.",
        "loading_episodes_msg" to "⏳ *در حال بارگذاری لیست قسمت‌ها...*\nلطفاً چند لحظه شکیبا باشید.",
        "resolving_links_msg" to "⏳ *در حال استخراج لینک‌های پخش مستقیم...*\nلطفاً چند لحظه شکیبا باشید.",
        "loading_feed_msg" to "⏳ *در حال دریافت عناوین فهرست...*\nلطفاً چند لحظه شکیبا باشید.",
...
""".trimIndent(),
        ...
        "btn_open_website" to "🌐 باز کردن لینک",
        "btn_view_album" to "🖼 مشاهده آلبوم تصاویر",
        "btn_image_pager" to "🖼 گالری و پیجر پوسترها",
        "btn_list_view" to "📋 حالت لیست متنی",
        "album_fallback_pager" to "⚠️ تلگرام امکان ارسال مستقیم آلبوم چندتایی از این هاست را نداشت. پیجر اختصاصی تصاویر باز شد!",
        "album_sent_success" to "✅ آلبوم تصاویر ارسال شد! جهت ورق زدن تکی تصاویر با ابعاد بزرگ، از پیجر استفاده کنید:",
        "poster_viewing_item" to "در حال مشاهده شماره %d: *%s*",
        "no_links_open_web" to "⚠️ *لینک مستقیم پخش برای این مورد یافت نشد.*\n\n👇 می‌توانید مستقیماً از وب‌سایت منبع تماشا کنید:",
        "load_failed_open_web" to "⚠️ *بارگذاری اطلاعات از سورس «%s» با خطا مواجه شد.*\n\nبه دلیل محافظت امنیتی کلودفلر یا عدم پاسخگویی سرور سایت، دریافت خودکار اطلاعات در ربات انجام نشد.\n\n👇 می‌توانید مستقیماً صفحه فیلم را در مرورگر خود باز کنید و تماشا نمایید:",
        "btn_open_browser" to "🌐 باز کردن لینک",
        "btn_back" to "⬅️ برگشت",
        "btn_close" to "✖️ بستن",
        "btn_prev" to "◀️ قبلی",
        "btn_next" to "بعدی ▶️",
        ...
        "feed_latest_title" to "✨ *جدیدترین و تازه‌ترین آثار منتشر شده*\nمنبع: *%s*",
        "btn_switch_source" to "🔄 تغییر سورس",
        "btn_random" to "🎲 پیشنهاد تصادفی",
        "btn_history" to "🕒 تاریخچه تماشا",
        "btn_categories" to "📂 دسته‌بندی‌ها",
        "btn_continue_watch" to "▶️ ادامه تماشا: %s",
        "btn_web_player" to "🎬 پخش در وب پلیر",
        "history_title" to "🕒 *تاریخچه و ادامه تماشا*\n\n👇 جهت ادامه تماشا روی هر عنوان بزنید:",
        "history_empty" to "🕒 هنوز فیلم یا سریالی تماشا نکرده‌اید.\nیک فیلم یا سریال جستجو کرده و شروع به تماشا کنید!",
        "categories_title" to "📂 *بخش‌ها و دسته‌بندی‌ها*\nمنبع: *%s*\n\n👇 یک دسته‌بندی را انتخاب کنید:",
        "categories_empty" to "⚠️ دسته‌بندی خاصی برای این منبع تعریف نشده است.",
        "random_title" to "🎲 *پیشنهاد شانسی و تصادفی برای امشب!*",
        "random_empty" to "⚠️ در حال حاضر امکان انتخاب پیشنهاد تصادفی میسر نشد. می‌توانید محبوب‌ترین‌ها را مشاهده کنید.",
